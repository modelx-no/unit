...
|===
	...
	xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Innhent data, detaljert verdistrøm konsument med kapabiliteter.adoc[Vis uten detaljer om elementene i diagrammet]

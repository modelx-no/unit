...
xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Del og innhent data og hendelser, detaljert verdistrøm datatilbyder med kapabiliteter.adoc[Vis uten detaljer  om elementene i diagrammet]

...
|===
[sidebar]xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Del og innhent data og hendelser, detaljert verdistrøm datatilbyder med kapabiliteter.adoc[Vis uten detaljer om elementene i diagrammet]

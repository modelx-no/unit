...
|===
[sidebar]xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Få tilgang til data - løsningsmønster UHF.adoc[Vis uten detaljer om elementene i diagrammet]

...
====
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Applikasjonsoversikt forespørsel integrert nasjonalt.adoc[Vis uten detaljer om elementene i diagrammet]
====

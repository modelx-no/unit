...
|===xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Del og innhent data, verdistrøm.adoc[Vis uten detaljer om elementene i diagrammet]

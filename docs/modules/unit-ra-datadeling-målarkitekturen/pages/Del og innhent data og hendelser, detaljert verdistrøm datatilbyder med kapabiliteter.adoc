...
****
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Del og innhent data og hendelser, detaljert verdistrøm datatilbyder med kapabiliteter.var.1.adoc[Vis detaljer om elementene i diagrammet] (kbd:[Shift]-klikk)
****

...
|===xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Informasjonsforvaltningsdomener.adoc[Vis uten detaljer om elementene i diagrammet]

...
|===xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Få tilgang til data - løsningsmønster UHF.var.1.adoc[Vis detaljer om elementene i diagrammet]

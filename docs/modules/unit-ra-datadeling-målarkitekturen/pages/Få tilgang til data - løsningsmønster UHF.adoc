...
****
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Få tilgang til data - løsningsmønster UHF.var.1.adoc[Vis detaljer om elementene i diagrammet] (kbd:[Shift]-klikk)
****

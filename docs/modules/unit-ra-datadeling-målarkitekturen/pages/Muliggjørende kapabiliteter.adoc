...
****
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Muliggjørende kapabiliteter.var.1.adoc[Vis detaljer om elementene i diagrammet] (kbd:[Shift]-klikk)
****

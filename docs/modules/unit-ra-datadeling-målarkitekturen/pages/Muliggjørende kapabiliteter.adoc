...
xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Muliggjørende kapabiliteter.var.1.adoc[Vis detaljer om elementene i diagrammet]

...
|===xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Tilgjengeliggjøre data etter forspørsel løsningsmønster UHF.adoc[Vis uten detaljer om elementene i diagrammet]

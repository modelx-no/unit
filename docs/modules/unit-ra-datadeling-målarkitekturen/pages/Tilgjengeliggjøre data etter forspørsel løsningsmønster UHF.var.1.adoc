...
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Tilgjengeliggjøre data etter forspørsel løsningsmønster UHF.adoc[Vis uten detaljer om elementene i diagrammet]

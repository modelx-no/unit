...
****
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Innhent data, detaljert verdistrøm konsument med kapabiliteter.var.1.adoc[Vis detaljer om elementene i diagrammet] (kbd:[Shift]-klikk)
****

...
****xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Tilgjengeliggjøre data etter forspørsel løsningsmønster UHF.var.1.adoc[Vis detaljer om elementene i diagrammet]

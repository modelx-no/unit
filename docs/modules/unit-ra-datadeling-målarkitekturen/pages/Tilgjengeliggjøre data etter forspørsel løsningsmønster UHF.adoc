...
xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Tilgjengeliggjøre data etter forspørsel løsningsmønster UHF.var.1.adoc[Vis detaljer om elementene i diagrammet]

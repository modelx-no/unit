...
|===
[sidebar]xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Applikasjonsoversikt forespørsel integrert med IAM.adoc[Vis uten detaljer om elementene i diagrammet]

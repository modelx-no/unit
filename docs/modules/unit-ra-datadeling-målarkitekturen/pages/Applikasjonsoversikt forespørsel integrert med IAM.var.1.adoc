...
|===xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Applikasjonsoversikt forespørsel integrert med IAM.adoc[Vis uten detaljer om elementene i diagrammet]

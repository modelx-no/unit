...
|===xref:C:\antora\modelx-no\components\unit-ra\docs\modules\unit-ra-datadeling-målarkitekturen\pages\Muliggjørende kapabiliteter.adoc[Vis uten detaljer om elementene i diagrammet]
